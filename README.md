...
![image-20210612205103539](README.assets/image-20210612205103539.png)

Как можно видеть, мы выполнили все указанные для данной работы операции при помощи разработанного консольного приложения. 

> Для регистрации сервиса и обращения к нему, он должен быть запущен и при этом, он не должен занимать порт 8080, который мы оставили для Tomcat контейнера сервлетов, используемого под jUDDI.
